            ...
            <Element name="faq" className="relative" >
                <div className="container relative z-2 py-28" >
                    <div>
                        ...
                        <p className="body-1 max-lg:max-w-sm">You've got questions, we've answers</p>
                    </div>
                ...
                <div className="faq-glow_before relative z-2 border-2 border-s2 bg-s1 " >
                    <div className="container flex gap-10 max-lg:block" >
                        ...
                        <div className="relative flex-1 pt-24" >
                            {faq.slice(0, halfFaq).map((item, index) => (
                               <FaqItem key={item.id} faq={item} index={index} />
                            ))}
                        </div>
                        <div className="relative flex-1 lg:pt-24" >
                            {faq.slice(halfFaq).map((item, index) => (
                               <FaqItem key={item.id} faq={item} index={halfFaq+index} />
                            ))}
                        </div>
